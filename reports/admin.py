...
from django.utils.translation import gettext_lazy as _ #Check from it for all files! gettext_lazy
...
class OrderAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context = None):
        ...
        #To convert the lists of year, months, weeks to language JavaScript unnderstand(json) to use the charts
        context = {
